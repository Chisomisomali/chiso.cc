...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <Card className="backdrop-blur-sm bg-white/20 dark:bg-white/5 border border-white/30 dark:border-white/10 hover:shadow-lg transition-all">
              <CardHeader>
                <CardTitle>Cloud Champion Birthday: Celebrating the Journey to the Cloud</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <p className="text-sm text-muted-foreground">This year's birthday theme celebrates becoming a Cloud Champion. Join me as I reflect on the journey, growth, and the song that accompanies this milestone.</p>
                <Link href="/blog">
            ...
            <Card className="backdrop-blur-sm bg-white/20 dark:bg-white/5 border border-white/30 dark:border-white/10 hover:shadow-lg transition-all">
              ...
              <CardContent className="space-y-3">
                <p className="text-sm text-muted-foreground">Building professional-grade self-hosted infrastructure and data center setup, exploring self-hosting advantages and best practices.</p>
                <Link href="/blog">
                  <Button variant="outline" size="sm" className="w-full">
                    Read Article
                  </Button>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/geek">
            <Button size="lg" className="bg-gradient-to-r from-purple-600 to-primary hover:from-purple-700 hover:to-primary/90">
              Enter Geek Mode Terminal <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </Link>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-white/5 dark:bg-black/40 border-t border-white/10 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center text-muted-foreground text-sm">
          <p>Chisomo Misomali © 2025 | IT Professional | Fiber Optics & Networking Specialist</p>
        </div>
      </footer>
    </div>
  )
